...
# ============================================================================
# MODELO: EmailConfirmationToken
# ============================================================================
# Token único para confirmar email durante el registro
# Expira en 24 horas y solo puede usarse una vez
# ============================================================================
...
class EmailConfirmationToken(models.Model):
    ...
    Se genera automáticamente al registrarse y se envía por email
    El usuario debe hacer clic en el link antes de 24h para activar su cuenta
    """
...
class PasswordResetToken(models.Model):
    """
    Token de recuperación de contraseña que expira en 1 hora

    Se genera cuando el usuario solicita resetear su contraseña
    El usuario recibe un email con un link que contiene el token
    El token solo puede usarse una vez y expira en 1 hora
    """
    ...
    def __str__(self):
        return f"Reset para {self.user.email} - {'Usado' if self.is_used else 'Activo'}"
    ...
    def create_token(cls, user, ip_address=None):
        ...
        Args:
            user: Instancia del usuario
            ip_address: Dirección IP desde donde se solicitó (opcional)
